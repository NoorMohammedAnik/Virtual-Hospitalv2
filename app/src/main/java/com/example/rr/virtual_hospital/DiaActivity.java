...
public class DiaActivity extends AppCompatActivity {
    ...
    String[] diaList={"APEX DIAGNOSTIC SERVICES (PVT.) LTD.",
            ...
            "CHEVRON CLINICAL LABORATORY (PVT.) LTD.","CHITTAGONG BELLEVUE LTD.","CHITTAGONG DOCTORS LAB (PVT.) LTD. ","CHITTAGONG LAB LTD. ","CHITTAGONG POLY CLINIC (PVT) LTD","CITY HEALTH CLINIC ","CITY HEALTH CLINIC ","CRESCENT DIAGNOSIS ","C.T. IMAGING & DIAGNOSTIC CENTRE LTD. ","CHITTAGONG METROPOLITAN HASPATAL DIAGNOSTIC LABORATORY","DIASONIC DIAGNOSTIC CENTRE ","DIVINE DIAGNOSTIC LTD. ","DR. MAHFUZUR RAHMAN'S LAB ","DR. MUSH DENTAL CLINIC ","EAGLES EYE DIAGNOSTIC ","EVERGREEN CLINIC (PVT) LTD. ","HEALTH HOME PVT. LTD.","HEALTH SENSE DIAGNOSTIC CENTRE","KIDNEY DIAGNOSTIC COMPLEX ","LAB EXPERTS (PVT) LTD.","LANCET ","LIFE CARE CENTRE ","MAGNUM DIAGNOSTIC COMPLEX ","MAHANAGAR CLINIC (PVT) LTD.",
